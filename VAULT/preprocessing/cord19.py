...
class Cord19Processor(DatasetProcessor):
    def __init__(self, datapath, overwrite):
        super().__init__(datapath, "cord19",  overwrite)
        self.id_dict = {}
    ...
    def process_qrels(self):
        ...
        if self.overwrite or not os.path.exists(qrel_path): 
            with open(qrel_in_file, "r") as qrel_in, \
                open(qrel_path, "w", encoding="utf-8") as f:
...
if __name__ == "__main__":
    ...
    processor = Cord19Processor(args.datapath, args.overwrite)
